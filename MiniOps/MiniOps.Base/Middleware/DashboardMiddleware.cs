...
namespace MiniOps.Base.Middleware
{
    ...
    {
        public static void AddDashboardService(IServiceCollection services)
        {
            services.AddRouting();
            services.AddSignalR();
            ...
            services.AddControllers().AddApplicationPart(typeof(DashboardMiddleware).Assembly);
        }
        public static void UseDashboard(IApplicationBuilder app, string basePath)
        {
            // Get the assembly and set up the embedded file provider (adjust the namespace as needed)
            var assembly = Assembly.GetExecutingAssembly();
            var embeddedFileProvider = new EmbeddedFileProvider(assembly, "MiniOps.Base.wwwroot");
